...
namespace RHTools
{
    public partial class SQLiteSample : Window
    {
        ...
        private void TextBoxDBFile_MouseDoubleClick(object sender, MouseButtonEventArgs e)
        {
            OpenFileDialog openFileDialog = new OpenFileDialog();
            if (openFileDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                dbFilePath = TextBoxDBFile.Text = openFileDialog.FileName;
            }
        }

        private void Button_Click_Connect(object sender, RoutedEventArgs e)
        {
            SQLiteHelper.SetConnectionString(dbFilePath, "", 3);

            if (SQLiteHelper.CanConnect())
            {
        ...
        {
            //DataTable dt = _SQLiteHelper.GetDataTable(TextBoxSQL.Text, null);
            //DataGridResult.ItemsSource = dt.DefaultView;

            DataTable dt = _SQLiteHelper.ExecuteQuery(TextBoxSQL.Text, null);
            DataGridResult.ItemsSource = dt.DefaultView;
        }
    }
